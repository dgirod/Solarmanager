...
async def async_setup_entry(
    ...
    for sensor in (sensor_coord.data or []):
        ...
        elif "ev" in sensor_type or "car_charger" in sensor_type or "charger" in sensor_type or "ladestation" in sensor_type or "car charging" in sensor_type or "charging" in sensor_type:
            entities.append(SolarManagerSelectEntity(
                client,
                SolarManagerSelectDescription(
